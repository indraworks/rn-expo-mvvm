...
export default RegisterStyles; // note dgn export default pada saat import bisa kita ganti variable nama yg diimport
///jadi bisa kita pakai import styles from ./Style
